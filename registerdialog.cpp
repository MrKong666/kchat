...
void RegisterDialog::showTip(QString str,bool b_ok=true)
{
    if(b_ok){
          ui->err_tip->setProperty("state","normal");
    }
...
void RegisterDialog::on_sure_pushButton_clicked()
{
    if(ui->user_lineEdit->text() == ""){
    ...
    json_obj["varifycode"] = ui->verify_lineEdit->text();
